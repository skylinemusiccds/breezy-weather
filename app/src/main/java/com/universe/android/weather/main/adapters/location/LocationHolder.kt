...
class LocationHolder(
    ...
    fun onBindView(context: Context, model: LocationModel, resourceProvider: ResourceProvider) {
        ...
        val elevatedSurfaceColor = com.universe.android.weather.common.utils.ColorUtils.getWidgetSurfaceColor(
        ...
        mBinding.item.setBackgroundColor(
            if (model.selected) com.universe.android.weather.common.utils.ColorUtils.blendColor(
